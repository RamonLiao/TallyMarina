...
beforeEach(() => {
  ...
  vi.spyOn(endpoints, 'confirmAnchor').mockResolvedValue({ id: 'a1', snapshotId: 's1', seq: 1, link: '0xLINK', digest: '0xDIGEST', explorerUrl: 'https://suiscan.xyz/testnet/tx/0xDIGEST', anchoredAt: 't', merkleRoot: null, periodId: '', leafCount: 0 });

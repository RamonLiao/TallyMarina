...
it('hash-chain renders with a null inclusion proof and unsorted seqs', () => {
  const anchors: AnchorDTO[] = [
    { id: 'a2', snapshotId: 's', seq: 2, link: '0xL2', digest: '0xD2', explorerUrl: 'https://x', anchoredAt: 't', merkleRoot: null, periodId: '', leafCount: 0 },
    { id: 'a1', snapshotId: 's', seq: 1, link: '0xL1', digest: '0xD1', explorerUrl: 'https://x', anchoredAt: 't', merkleRoot: null, periodId: '', leafCount: 0 },
  ];

...
// Extracted to web/src/lib/fmtMinor.ts (Task 12 — shared with the revaluation trial table).
// Re-exported below so existing callers/tests importing from ReconTable keep working.
